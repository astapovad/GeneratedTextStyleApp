...
style = st.selectbox(
    ...
    ["Офіційний", "Креативний", "Науковий", "Формальний", "Мотиваційний", "Розповідь"]
)

prompt_styles = {
    "Офіційний": "Напиши цей текст у формальному, офіційному стилі:",
    "Креативний": "Напиши цей текст у форматі для використання рекламних банерів, сторітелінгу, презентацій, неймінгу, підписів для соцмереж і закадрових текстів вірусних роликів. Це можуть бути також маленькі слогани :",
