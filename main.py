    ...
    with st.spinner("Генерується..."):
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "system", "content": "Усі речення мають бути логічно зв’язані, лексика – відповідна до стилю, а пунктуація – коректною. Не забувай використовувати відмінки у словах та пунктуацію в реченнях згідно правилам української мови."},
