...
st.write("""
Вітаємо!  
Цей генератор допоможе перетворити ваш текст у обраний стиль: офіційний, креативний, науковий, академічний, простий або мотиваційний.  
Просто введіть текст, оберіть стиль і натисніть «Згенерувати текст».  
Отримаєте граматично правильний та стильово адаптований результат українською мовою.
""")
